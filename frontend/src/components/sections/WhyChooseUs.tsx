...
const points = [
  {
    ...
    body: "Oral examinations, diagnosis, and treatment planning grounded in evidence-based practice — from routine dental procedures to orthodontic treatment, with a focus on continuous learning and clinical excellence.",
  },
  {
    num: "02",
    emoji: "🎓",
    title: "Postgraduate Orthodontic Training",
    body: "MDS in Orthodontics & Dentofacial Orthopaedics from Atal Bihari Vajpayee Medical University, Lucknow, and a BDS from KD Dental College, Mathura — combined with hands-on experience in general dental practice.",
  },
  {
    num: "03",
    emoji: "📚",
    title: "Committed to Continuous Learning",
    body: "Ongoing training beyond the degree — including Mastering Clear Aligners at AIIMS Delhi, Clinical Application of Lasers in Dentistry, and Max Emergency Life Support — to stay current with evidence-based patient care.",
  },
];
    ...
    <section id="why" className="py-32 bg-white dark:bg-[#09090b]">
      <div className="container mx-auto px-6">
        ...
        <m.div
          ...
          <m.p variants={fadeUp} className="section-label">🩺 Why Choose This Practice</m.p>
          <m.h2 variants={fadeUp} className="section-heading mt-4">
            What sets this<br/>practice apart
          </m.h2>
        </m.div>
